...
# hold on how often the pull request is read, not a lag to wait out, and a
...
# The hold is what keeps the gate from reading the pull request on every poll;
...
# on the first poll, collapsing the hold to nothing.
arr 1
